...
\paragraph{}
Les neurones sont réparties dans différentes couche. Comme le simulateur pour le moment suit le modèle restreins de machine de Boltzmann, les eul communication entre les neurones se font entre des couche voisine. Il n'y a donc pas non plus d
