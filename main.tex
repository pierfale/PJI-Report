...
\paragraph{}
Le projet à été pensée de façon générique : il doit pouvoir s’adapter a différent modèle de réseau. Pour le moment seul le modèle QBG est implémenté. C’est pourquoi le projet est répartie dans différents packages de la façon suivante :
\begin{itemize}
...
\begin{figure}[!h]
\includegraphics[scale=0.95,right]{image/synapsesActivity.png}
