...
Bien que nous ayons déjàà travaillé ensemble, le PJI nous a permis de renforcer notre travail d'équipe, ainsi que d'apprendre  le Scala, qui est un langage extrêment puissant. Nous avons également put pratiquer un peu de fonctionnel, et de la programmation orientés agent / messages.
...
Le projet nous a permis de rencontrer des personnes intérressante. Nous avons pu dégager un contrat avec l'équipe pour continuer de travaillé cet été sur N2S3.
